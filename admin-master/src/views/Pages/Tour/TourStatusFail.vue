              ...
              <div style="width: 150px">
                <div class="float-left pr-3">
                  <b-icon
                    ...
                    scale="1.5"
                    variant="danger"
                    @click.prevent="notifiedDeletTour(data.item._id)"
                  >
                  </b-icon>
                </div>
                <div class="float-left pr-3">
      ...
      <div class="m-4">
        <b-row>
          <b-col cols="4">
            ...
            >
              <div v-for="(value, index) in tour.listImage" :key="index">
                <b-carousel-slide :img-src="value"> </b-carousel-slide>
              </div>
            </b-carousel>
          </b-col>
          <b-col cols="8">
            ...
            <b-row>
              ...
              <b-col cols="8" class="title-customs text-monospace">
                <b-row>
                  <b-col cols="4" class="text-monospace font-weight-bold">
                    Người lớn
                  </b-col>

                  <b-col cols="4" class="title-customs text-monospace">
...
export default {
  ...
  methods: {
    ...
    getAllTour() {
      let uri = `${process.env.VUE_APP_PORT}/tours/status/false`;
